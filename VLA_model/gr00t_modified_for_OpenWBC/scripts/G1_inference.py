            ...
            while running:
                ...
                if current_flag:
                    ...
                    if num == 0:
                        ...
                        if WRIST:
                            obs["video.wrist_left"] = current_wrist_image[:, :wrist_img_shape[1]//2].reshape(1, H, wrist_img_shape[1]//2, C)
                            obs["video.wrist_right"] = current_wrist_image[:, wrist_img_shape[1]//2:].reshape(1, H, wrist_img_shape[1]//2, C)
                    ...
                    if args.vis:
                        ...
                        for key in arm_keys:
                            try:
                                ...
                                stats.append(np.zeros_like(action[f"action.{('base_motion' if key == 'right_leg' else key)}"][0]))
